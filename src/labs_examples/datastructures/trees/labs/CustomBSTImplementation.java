...
public class CustomBSTImplementation {

    BSTNode rootNode;
    int size;
    CustomBSTImplementation(int ... data) {
    ...
    private BSTNode rebalanceInsert(BSTNode node, int data) {
    ...
    private BSTNode rotateRight(BSTNode node) {
        ...
        BSTNode formerRightChild = child.rightChild;
    ...
    private BSTNode rotateLeft(BSTNode node) {
        ...
        BSTNode grandChild = child.leftChild;
    ...
    public void remove(int target) {
        ...
        rootNode = remove(target, rootNode);
    }

    boolean search(int target) {
        // call the search helper (recursive) method
        return search(target, rootNode);
    }

    boolean search(int target, BSTNode node) {
    ...
    private BSTNode remove(int target, BSTNode node) {
        ...
        // currently at the target Node
            ...
            // two branches
                ...
                BSTNode smallest = node.rightChild;
    ...
    private BSTNode rebalanceRemove(BSTNode node) {
    ...
    public void printInorderRecursive(BSTNode node) {
        if (node == null)
            return;
