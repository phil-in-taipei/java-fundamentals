...
public class DataStreamReadWriteExample {
    public static void main(String[] args) {
        ...
        try(DataOutputStream output = new DataOutputStream(new FileOutputStream(outputFilePath))){
        ...
        try(DataInputStream input = new DataInputStream(new FileInputStream(outputFilePath))){
